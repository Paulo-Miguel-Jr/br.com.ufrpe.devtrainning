...
public class FichaTreino  {
    ...
    public FichaTreino(int idTreino, Professor professor, Cliente cliente, LocalDate dataCriacao, String tipoTreino) {
    ...
    public static void executarTreinoCostas(String tipoTreino) {
        ...
        FichaTreino ficha = new FichaTreino(1, professor1, cliente, new LocalDate(), tipoTreino);
    ...
    public static void executarTreinoPeito(String tipoTreino) {
        ...
        FichaTreino ficha = new FichaTreino(1, professor1, cliente, new LocalDate(), "Peito");
